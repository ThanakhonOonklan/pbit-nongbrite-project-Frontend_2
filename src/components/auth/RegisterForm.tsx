  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <Step>
          {/* Logo / Brand */}
          <div className="flex items-center justify-center gap-3 mb-4 md:mb-5 text-center">
          ...
          {/* Input Fields */}
          <div className="relative z-10 flex flex-col gap-5 md:gap-6 w-full min-h-[280px]">
            <InputField
              label="อีเมล"
              type="email"
