...
export const PATH_PATTERN_SETS: Record<number, PathNavLevelConfig[]> = {
    ...
    7: [
        // A — S bottom-left, N top-right, H mid-interior
        {
            level: 7, difficulty: "hard", gridCols: 6, gridRows: 6, homePos: { row: 3, col: 2 },
            startPos: { row: 5, col: 0 }, nongBritePos: { row: 0, col: 5 },
            blockedTiles: [{ row: 1, col: 0 }, { row: 1, col: 2 }, { row: 1, col: 4 }, { row: 2, col: 3 }, { row: 3, col: 4 }, { row: 4, col: 1 }, { row: 5, col: 4 }]
        },
        // B — S mid-right, N bottom-left, H top-right
        {
            level: 7, difficulty: "hard", gridCols: 6, gridRows: 6, homePos: { row: 0, col: 5 },
            startPos: { row: 3, col: 4 }, nongBritePos: { row: 5, col: 0 },
            blockedTiles: [{ row: 0, col: 1 }, { row: 1, col: 3 }, { row: 2, col: 1 }, { row: 2, col: 5 }, { row: 3, col: 3 }, { row: 4, col: 1 }, { row: 5, col: 3 }]
        },
        // C — S mid-interior, N bottom-right, H mid-left
        {
            level: 7, difficulty: "hard", gridCols: 6, gridRows: 6, homePos: { row: 2, col: 1 },
            startPos: { row: 3, col: 2 }, nongBritePos: { row: 5, col: 5 },
            blockedTiles: [{ row: 1, col: 1 }, { row: 1, col: 5 }, { row: 2, col: 2 }, { row: 3, col: 1 }, { row: 3, col: 4 }, { row: 4, col: 2 }, { row: 5, col: 0 }]
        },
        // D — S top-right, N top-left, H mid-right
        {
            level: 7, difficulty: "hard", gridCols: 6, gridRows: 6, homePos: { row: 4, col: 5 },
            startPos: { row: 0, col: 5 }, nongBritePos: { row: 0, col: 0 },
            blockedTiles: [{ row: 0, col: 1 }, { row: 1, col: 1 }, { row: 1, col: 4 }, { row: 2, col: 1 }, { row: 3, col: 4 }, { row: 4, col: 3 }, { row: 5, col: 2 }]
        },
    ],

    8: [
        // A — S top-mid-left, N bottom-left, H top-left
        {
            level: 8, difficulty: "hard", gridCols: 6, gridRows: 6, homePos: { row: 0, col: 0 },
            startPos: { row: 0, col: 2 }, nongBritePos: { row: 5, col: 0 },
            blockedTiles: [{ row: 0, col: 1 }, { row: 1, col: 1 }, { row: 2, col: 3 }, { row: 2, col: 5 }, { row: 3, col: 1 }, { row: 4, col: 0 }, { row: 4, col: 2 }, { row: 4, col: 3 }]
        },
        // B — S bottom-mid-left, N top-left, H mid-left
        {
            level: 8, difficulty: "hard", gridCols: 6, gridRows: 6, homePos: { row: 4, col: 0 },
            startPos: { row: 5, col: 2 }, nongBritePos: { row: 0, col: 0 },
            blockedTiles: [{ row: 0, col: 4 }, { row: 1, col: 0 }, { row: 1, col: 2 }, { row: 2, col: 1 }, { row: 2, col: 5 }, { row: 3, col: 2 }, { row: 4, col: 3 }, { row: 5, col: 1 }]
        },
        // C — S top-mid-right, N mid-right, H top-right
        {
            level: 8, difficulty: "hard", gridCols: 6, gridRows: 6, homePos: { row: 1, col: 5 },
            startPos: { row: 1, col: 3 }, nongBritePos: { row: 2, col: 4 },
            blockedTiles: [{ row: 1, col: 1 }, { row: 1, col: 4 }, { row: 2, col: 0 }, { row: 2, col: 3 }, { row: 2, col: 5 }, { row: 3, col: 2 }, { row: 4, col: 0 }, { row: 4, col: 3 }]
        },
        // D — S bottom-mid-left, N top-mid-right, H mid-interior
        {
            level: 8, difficulty: "hard", gridCols: 6, gridRows: 6, homePos: { row: 3, col: 2 },
            startPos: { row: 4, col: 1 }, nongBritePos: { row: 1, col: 4 },
            blockedTiles: [{ row: 0, col: 3 }, { row: 1, col: 1 }, { row: 2, col: 2 }, { row: 2, col: 3 }, { row: 2, col: 5 }, { row: 3, col: 3 }, { row: 4, col: 4 }, { row: 5, col: 0 }]
        },
    ],

    9: [
        // A — S bottom-right, N bottom-mid-left, H mid-left
        {
            level: 9, difficulty: "hard", gridCols: 7, gridRows: 7, homePos: { row: 2, col: 0 },
            startPos: { row: 6, col: 6 }, nongBritePos: { row: 6, col: 1 },
            blockedTiles: [{ row: 1, col: 1 }, { row: 1, col: 2 }, { row: 2, col: 1 }, { row: 3, col: 0 }, { row: 3, col: 4 }, { row: 4, col: 3 }, { row: 5, col: 1 }, { row: 5, col: 2 }, { row: 5, col: 5 }, { row: 6, col: 2 }]
        },
        // B — S mid-interior, N bottom-interior, H mid-interior
        {
            level: 9, difficulty: "hard", gridCols: 7, gridRows: 7, homePos: { row: 3, col: 3 },
            startPos: { row: 2, col: 3 }, nongBritePos: { row: 5, col: 3 },
            blockedTiles: [{ row: 1, col: 3 }, { row: 2, col: 1 }, { row: 2, col: 5 }, { row: 3, col: 0 }, { row: 3, col: 6 }, { row: 4, col: 2 }, { row: 4, col: 3 }, { row: 4, col: 4 }, { row: 5, col: 1 }, { row: 5, col: 5 }]
        },
        // C — S top-interior, N bottom-interior, H top-interior
        {
            level: 9, difficulty: "hard", gridCols: 7, gridRows: 7, homePos: { row: 1, col: 3 },
            startPos: { row: 0, col: 3 }, nongBritePos: { row: 5, col: 3 },
            blockedTiles: [{ row: 1, col: 2 }, { row: 1, col: 4 }, { row: 2, col: 3 }, { row: 3, col: 0 }, { row: 3, col: 2 }, { row: 3, col: 4 }, { row: 3, col: 6 }, { row: 4, col: 3 }, { row: 5, col: 1 }, { row: 5, col: 5 }]
        },
        // D — S mid-interior, N bottom-right, H top-left
        {
            level: 9, difficulty: "hard", gridCols: 7, gridRows: 7, homePos: { row: 0, col: 0 },
            startPos: { row: 3, col: 3 }, nongBritePos: { row: 6, col: 6 },
            blockedTiles: [{ row: 0, col: 3 }, { row: 1, col: 1 }, { row: 1, col: 5 }, { row: 2, col: 2 }, { row: 3, col: 0 }, { row: 3, col: 6 }, { row: 4, col: 4 }, { row: 5, col: 1 }, { row: 5, col: 5 }, { row: 6, col: 3 }]
        },
    ],
};
