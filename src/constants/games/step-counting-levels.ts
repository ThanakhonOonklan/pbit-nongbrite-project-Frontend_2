...
export const stepCountingLevels: Record<number, LoopLevelConfig> = {
  ...
  // L1: single task
  1: {
    level: 1, difficulty: "easy", variants: [
  ...
  // L2: single task
  2: {
    level: 2, difficulty: "easy", variants: [
  ...
  // L3: 2 tasks
  3: {
    level: 3, difficulty: "easy", variants: [
  ...
  // L4: 2 tasks
  4: {
    level: 4, difficulty: "normal", variants: [
  ...
  // L5: 2 tasks
  5: {
    level: 5, difficulty: "normal", variants: [
  ...
  // L6: 2 tasks
  6: {
    level: 6, difficulty: "normal", variants: [
  ...
  // L7: 3 tasks
  7: {
    level: 7, difficulty: "hard", variants: [
  ...
  // L8: 3 tasks
  8: {
    level: 8, difficulty: "hard", variants: [
  ...
  // L9: 4 tasks
  9: {
    level: 9, difficulty: "hard", variants: [
